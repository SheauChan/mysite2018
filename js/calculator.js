window.onload = function () {
    var screen; // result div HTML element tag (store the math question string or result value)
    var output; // for calcultaiton the question string, eg "1X2+"
    var limit; // limit for calculator inout to 16
    ...
    document.querySelector (".period") .addEventListener ("click", function(){
        ...
        if(screen.innerHTML === "") {
            ...
            output = screen.innerHTML; //output = screeen.innerHTML + screen.innerHTML.concat ("0");
        } else if (screen.innerHTML === output) {
